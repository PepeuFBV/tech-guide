        ...
        <div className='w-full h-full flex items-start justify-start md:space-x-10'>
            <div className='w-full md:w-[75%] lg:w-[80%] mt-5 md:mt-0 flex flex-col justify-center space-y-3 px-3 md:px-10'>
                ...
                <div className='flex flex-col space-y-10'>
                    ...
                    <div className='flex flex-col space-y-4'>
                        <h2 id='how-it-works' className='text-3xl'>Como funciona?</h2>
                    ...
                    <Divider variant='horizontal' color='secondary' className='w-full' />
                    <div className='flex flex-col space-y-4'>
                        <h2 id='layouts' className='text-3xl'>Layouts</h2>
                    ...
                    <Divider variant='horizontal' color='secondary' className='w-full' />
                    <div className='flex flex-col space-y-4'>
                        <h2 id='navigation' className='text-3xl'>Navegação</h2>
                    ...
                    <div className='flex flex-col space-y-6'>
                        <div className='flex flex-col space-y-4'>
                            <h2 id='dynamic-routes' className='text-3xl'>Rotas Dinâmicas</h2>
                    ...
                    <Divider variant='horizontal' color='secondary' className='w-full' />
                    <div className='flex flex-col space-y-4'>
                        <h2 id='page-not-found' className='text-3xl'>Página não encontrada</h2>
