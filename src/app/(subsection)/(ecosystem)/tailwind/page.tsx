    ...
    return (
        <div className='w-full h-full flex items-start justify-start md:space-x-10'>
            <div className='w-full md:w-[75%] lg:w-[80%] mt-5 md:mt-0 flex flex-col justify-center gap-4 px-3 md:px-10'>
                ...
                <Divider variant='horizontal' color='secondary' className='w-full' />
                <section id='customization' className='flex flex-col gap-4'>
                    <h2 className='text-3xl'>Customização</h2>
                ...
                <Divider variant='horizontal' color='secondary' className='w-full' />
                <section id='modifiers' className='flex flex-col gap-4'>
                    <h2 className='text-3xl'>Modificadores</h2>
