    ...
    return (
        <div className='w-full h-full flex items-start justify-start md:space-x-10'>
            <div className='w-full md:w-[75%] lg:w-[80%] mt-5 md:mt-0 flex flex-col justify-center gap-4 px-3 md:px-10'>
                ...
                <section id='what-is-typescript' className='flex flex-col gap-4'>
                ...
                <Divider variant='horizontal' color='secondary' className='w-full' />
                <section id='configuration' className='flex flex-col gap-4'>
                ...
                <section id='types' className='flex flex-col gap-4'>
                    <h2 className='text-3xl'>Tipos Básicos</h2>
                ...
                <Divider variant='horizontal' color='secondary' className='w-full' />
                <section id='interfaces' className='flex flex-col gap-4'>
                    <h2 className='text-3xl'>Interfaces</h2>
                ...
                <Divider variant='horizontal' color='secondary' className='w-full' />
                <section id='generics' className='flex flex-col gap-4'>
                    <h2 className='text-3xl'>Generics</h2>
