    ...
    return (
        <div className='w-full h-full flex items-start justify-start md:space-x-10'>
            <div className='w-full md:w-[75%] lg:w-[80%] mt-5 md:mt-0 flex flex-col justify-center gap-4 px-3 md:px-10'>
                ...
                <section id='what-are-software-tests' className='flex flex-col gap-4'>
                    <h2 className='text-3xl'>O que são testes de software?</h2>
                ...
                <Divider variant='horizontal' color='secondary' className='w-full' />
                <section id='what-is-jest' className='flex flex-col gap-4'>
                    <h2 className='text-3xl'>O que é o Jest?</h2>
                ...
                <Divider variant='horizontal' color='secondary' className='w-full' />
                <section id='building-tests' className='flex flex-col gap-4'>
                    <h2 className='text-3xl'>Construindo testes</h2>
