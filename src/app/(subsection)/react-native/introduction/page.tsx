...
// Tópicos atualizados para a navegação da página de React Native
const topics: Topic[] = [
        ...
        <div className='w-full h-full flex items-start justify-start md:space-x-10'>
            <div className='w-full md:w-[75%] lg:w-[80%] mt-5 md:mt-0 flex flex-col justify-center gap-4 px-3 md:px-10'>
                ...
                <section id='why-use-expo' className='flex flex-col gap-4'>
                    ...
                    <p className='text-secondary'>Se o React Native é o motor do carro, o <strong>Expo</strong> é todo o resto: o chassi, o painel, o GPS e o ar-condicionado. Expo é um conjunto de ferramentas e serviços construído em cima do React Native que simplifica drasticamente o desenvolvimento.</p>
                    <p className='text-secondary'>Pense no Expo como o "Next.js" do mundo mobile. Ele resolve os principais pontos de dor:</p>
                    <ul className='list-disc list-inside space-y-2 my-4 text-secondary'>
                ...
                <section id='dev-environment' className='flex flex-col gap-8'>
                    <div className='flex flex-col gap-4'>
                        ...
                        <p className='text-secondary'>Aqui a prática é um pouco diferente da web. Vamos deixar o ambiente pronto para rodar nosso primeiro app. Siga os passos com atenção.</p>
                    </div>
                    <div className='flex flex-col gap-2'>
                        <h3 className='text-2xl'>Passo 1: Instalar as ferramentas (se necessário)</h3>
                        <p className='text-secondary'>O EAS CLI é a ferramenta de linha de comando do Expo para fazer o "build" do seu aplicativo (o passo final para enviá-lo para as lojas). É bom já deixá-lo instalado. Abra seu terminal e rode:</p>
                     ...
                     <div className='flex flex-col gap-2'>
                        ...
                        <p className='text-secondary'>Agora, vamos criar a pasta e os arquivos iniciais do nosso app. É o equivalente ao `create-react-app`.</p>
                        <pre className='bg-gray-800 text-white p-4 rounded-md my-2 overflow-x-auto'><code>npx expo init meu-primeiro-app</code></pre>
                     ...
                     <div className='flex flex-col gap-2'>
                        ...
                        <p className='text-secondary'>Um passo simples, mas que muitos esquecem! O terminal não entra na pasta nova sozinho.</p>
                        <pre className='bg-gray-800 text-white p-4 rounded-md my-2 overflow-x-auto'><code>cd meu-primeiro-app</code></pre>
                    </div>
                     <div className='flex flex-col gap-2'>
                        <h3 className='text-2xl'>Passo 4: Iniciar o servidor de desenvolvimento</h3>
                        <p className='text-secondary'>Este é o comando que você mais vai usar. Ele inicia o "Metro Bundler", um servidor que compila seu código JavaScript e o disponibiliza para o aplicativo.</p>
                        <pre className='bg-gray-800 text-white p-4 rounded-md my-2 overflow-x-auto'><code>npx expo start</code></pre>
                     ...
                     <div className='flex flex-col gap-2'>
                        ...
                        <p className='text-secondary'>Em segundos, o aplicativo que você acabou de criar será carregado no seu celular. Qualquer alteração que você fizer no código será refletida quase que instantaneamente. Bem-vindo ao desenvolvimento mobile com React Native e Expo!</p>
                    </div>
                </section>
            </div>
